// const Moonbeam = require('../moonbeam-spawn')
...
//   const p = new Moonbeam({
//     port: '39393',
//     parityExec: require('moonbeam-binary'),
//     basePath: await fs.mkdtemp(path.join(os.tmpdir(), 'tape-moonbeam-')),
//     light: false,
//     ipc: true,
//     ws: false,
//     jsonrpc: false,
